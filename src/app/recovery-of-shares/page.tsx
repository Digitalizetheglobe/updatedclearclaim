...
export default function RecoveryOfShares() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch("/api/share-recovery", {
      ...
      .catch(() => {
        setToastMessage("There was an error sending your message. Please try again or contact us at +91 9156701900 / +91 9970651900.");
        setShowModal(true);
      })
      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="relative bg-[#1a3a1f] text-white py-16 md:py-24 overflow-hidden min-h-screen flex items-center">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="absolute inset-0 bg-[url('/images/geomatric.png')] bg-cover bg-center mix-blend-overlay"></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-fade-in-up-light opacity-0 [animation-fill-mode:forwards] [animation-delay:0ms]">
                <h1 className="text-3xl md:text-4xl lg:text-4xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
                  India&apos;s No.1 <span className="text-[#00BE5D]">Shares Recovery</span> Experts
                </h1>
              ...
              <div id="form" className="bg-white rounded-3xl p-5 md:p-6 shadow-2xl border border-gray-100 animate-fade-in-up-light opacity-0 [animation-fill-mode:forwards] [animation-delay:120ms] max-w-md ml-auto">
                <div className="mb-4">
                  ...
                  {/* <p className="text-gray-500 mt-1 text-xs font-semibold italic">Free expert consultation for your share recovery</p> */}
                </div>

                <form ref={heroFormRef} onSubmit={handleSubmit} className="space-y-3">
                  <div>
                    <label htmlFor="hero_first_name" className="text-gray-700 text-[11px] font-bold uppercase ml-1 block mb-1.5">
                      First Name
                    </label>
                    <input
                      id="hero_first_name"
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {formSubmitting ? "Processing..." : "Get Free Expert Consulting"}
                    </button>
