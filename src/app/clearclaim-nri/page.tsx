            ...
            <div className="animate-fade-in-up-light opacity-0 [animation-fill-mode:forwards] [animation-delay:0ms]">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20">
                  <div className="text-2xl font-bold text-white">₹600+ Cr</div>
                  <div className="text-white/80 text-sm">Recovered for Clients</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20">
                  <div className="text-2xl font-bold text-white">14+ Years</div>
                  <div className="text-white/80 text-sm">Recovery Experience</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mb-8 text-sm">
                ...
                <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full">
                  <span className="text-white/90">✓ 60+ Expert Team</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-[#f8fdf9] to-[#e6f7ed] animate-fade-in-up-light opacity-0 [animation-fill-mode:forwards] [animation-delay:480ms]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center animate-fade-in-up-light opacity-0 [animation-fill-mode:forwards] [animation-delay:400ms]">
            ...
            <a 
              href="tel:+919156701900" 
              className="inline-flex items-center gap-2 bg-[#00BE5D] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#008C44] transition shadow-lg hover:shadow-xl"
            >
              <Image src={phoneIcon} alt="Phone" width={20} height={20} />
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-8">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <Image src={phoneIcon} alt="Phone" width={20} height={20} className="invert" />
                </div>
              ...
              >
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <Image src={emailIcon} alt="Email" width={20} height={20} className="invert" />
                </div>
                <div className="text-left">
