...
import design from "../../public/images//Clear claim banner (1).gif";
  ...
  return (
    <>
      <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6 max-w-5xl max-md:max-w-md mx-auto">
        {/* Left Section */}
        <div className="max-md:order-1 max-md:text-left">
          ...
          {/* Alignment Container */}
          <div className="mt-4 flex flex-col items-start gap-4 px-4 md:pl-12">
  {/* Heading */}
