              ...
              <div className="text-left text-justify">
                ...
                <ul className="space-y-6 mb-6 text-gray-500 sm:text-md md:mb-8 p-4">
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    ...
                    notified new rules under Section 124(6) in The Companies
                    Act, 2013, The Investor Education and Protection Fund
                    Authority [Accounting, Audit, Transfer and Refund] Rules,
                    2016 which vide Rule 6 has been implemented by the Ministry
                    of Corporate Affairs, with effect from 13th October 2017.
                  </li>
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    {/* <Image src={tick} alt="clearclaim" className="w-5 h-6" /> */}
                    ...
                    details as may be prescribed: Provided that any claimant of
                    shares transferred above shall be entitled to claim the
                    transfer of shares from Investor Education and Protection
                    Fund in accordance with such procedure and on submission of
              ...
              <div className="bg-[#00BE5D] text-white py-4 px-6">
                ...
                <ul className="space-y-6 mb-6 text-gray-500 sm:text-md md:mb-8 p-4">
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    ...
                    transferred to IEPF. Along with the MCA rule of transmission
                    of shares to IEPF, they have also given the process of
                    claiming shares back from IEPF. By submitting IEPF-5 claim
                    form on MCA website you can claim your shares from IEPF.
                  </li>
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                  ...
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    <Image src={tick} alt="clearclaim" className="w-5 h-6" />
                    1. Filing IEPF-5 claim online on MCA portal and generate a
                    SRN number. After that sending hard copy documents to the
                    Nodal officer or RTA of the company.
                  </li>
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    <Image src={tick} alt="clearclaim" className="w-5 h-6" />
                    2. Company verifies your claim by scrutinizing documents you
                    submitted and sends verification report to IEPFA through
                    their internal portal.
                  </li>
                  <li className="flex gap-3 text-md text-[16px] text-[rgba(0, 0, 0, 0.6)]">
                    <Image src={tick} alt="clearclaim" className="w-5 h-6" />
                    3. IEPFA approves or rejects your claim after their
                    verification.
                  </li>
                </ul>
              </div>
