...
import ultratech from "../../../../public/casestudy/Ultratech_Cement_Logo.svg_.png";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";


export default function UltratechCement() {
      ...
      <div>
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            Ultratech 
              <span className="text-green-600"> Cement</span>
            </h1>
            ...
            <section className="bg-white p-4">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Ultratech Cement 
                </li>
                <li>
                  <b>CIN Number: </b>L26940MH2000PLC128420 
                </li>
                <li>
                  <b>ISIN Number: </b>INE481G01011
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                Dividend History Of Ultratech Cement 
                </h2>
              </div>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">30 Jul, 2024</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">70.00</td>
                    </tr>
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">38.00</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">29 Apr, 2022</td>
                      <td className="text-gray-600 p-3">02 Aug, 2022 </td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">38.00</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      07 May, 2021
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                      <td className="text-gray-600 bg-gray-100 p-3">37.00</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">20 May, 2020</td>
                      <td className="text-gray-600 p-3">29 Jul, 2020 </td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">25 Apr, 2018</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">25 Apr, 2016</td>
                      <td className="text-gray-600 p-3">04 Jul, 2016</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">23 Apr, 2014 </td>
                      <td className="text-gray-600 p-3">24 Jul, 2014</td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">17 Aug, 2012 </td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">29 Apr, 2010</td>
                      <td className="text-gray-600 p-3">21 Jun, 2010</td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">22 Apr, 2008 </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">10 Jul, 2006</td>
                      <td className="text-gray-600 p-3">14 Aug, 2006 </td>
                      <td className="text-gray-600 p-3">Final </td>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <p className="text-gray-500">Demerger- 1. On May 14 2004 Larsen and Toubro demergered Ultratech in the ratio of 5:2 that is for every 5 shares held in Larsen and Toubro the shareholder will receive 2 shares in Ultratech Cement (formerly known as Ultratech Cemco Limited).              </p>
              <p className="text-gray-500">2. On 1 June 2018, Century Textiles demergered from Ultratech in the ratio of 1:8 that is for every 8 shares held in Century Textiles the shareholder will receive 1 equity share of Ultratech Cement. </p>
              <p className="text-gray-500">Merger- 1. In the year 2005, Narmada Cement was mergered in Ultratech Cement in the ratio of 1:18 that is for every 18 shares held in Narmada Cement the shareholder will receive 1 share in Ultratech Cement.
              </p>
              <p className="text-gray-500">2.In the year 2009, Samruddhi Cement mergered with Ultratech Cement in the ratio of 4:7 that is for every 7 shares held in Samruddhi Cement the shareholder will receive 4 equity shares in Ultratech Cement.
              </p>
            </section>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Unclaimed Shares and Dividends Of Ultratech Cement Transferred To IEPF
                </h2>
              </div>
            ...
            <section id="why-my-Share" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Why my shares of Ultratech Cement are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
...
The company transfers the shares to IEPF when the dividends of seven or more consecutive years are not claimed by the shareholder.
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Link
                    ...
                    href="http://www.ultratechcement.com/"
                  >
