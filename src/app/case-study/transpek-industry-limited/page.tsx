...
import Transpek from "../../../../public/casestudy/transpek-logo-final.webp";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";


export default function TranspekIndustryLimited() {
      ...
      <div>
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            Transpek
              <span className="text-green-600"> Industry Limited</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            Transpek Industry Limited is an Indian company primarily engaged in the manufacture and supply of chemicals, specializing in organic and inorganic products. Established in 1981, the company has earned a reputation for producing high-quality chemicals that cater to various industries, including pharmaceuticals, agrochemicals, plastics, and rubber.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Transpek is committed to sustainability and environmental safety. It adheres to strict environmental and safety norms, ensuring minimal impact on the environment while maintaining product quality. The company also emphasizes continuous innovation and research to meet the evolving demands of the chemical industry.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Transpeks customer base includes several multinational corporations, and it has built long-term relationships through its consistent product quality and reliable delivery schedules. The company also emphasizes corporate social responsibility (CSR) activities, contributing to various social and environmental causes.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Overall, Transpek Industry Limited stands out as a significant player in the Indian chemical industry, known for its expertise in specialized chemicals and a commitment to quality, innovation, and sustainability.
            </p>
            <Image
              src={Transpek}
              alt="Transpek"
            ...
            <section className="bg-white p-4">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Transpek Industry Limited
                </li>
                <li>
                  <b>CIN Number: </b> L23205GJ1965PLC001343
                </li>
                <li>
                  <b>ISIN Number: </b> INE687A01016
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                Dividend Of Transpek Industry Limited
                </h2>
              </div>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">21 Aug, 2023 </td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">05 Sep, 2022</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">05 Sep, 2022 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">25 May, 2021 </td>
                      <td className="text-gray-600 p-3">06 Sep, 2021</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">15 Sep, 2020 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">01 Aug, 2019 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">08 Aug, 2017 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">10 Sep, 2015 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">02 Jun, 2014 </td>
                      <td className="text-gray-600 p-3">09 Sep, 2014</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">31 Jul, 2013 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">30 May, 2011 </td>
                      <td className="text-gray-600 p-3">16 Aug, 2011</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">04 Aug, 2010 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">12 Jun, 2009 </td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">12 Aug, 2008 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">27 Jun, 2007 </td>
                      <td className="text-gray-600 p-3">28 Aug, 2007</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">14 Aug, 2006 </td>
                      <td className="text-gray-600 bg-gray-100 p-3">Final</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">05 Jul, 2005 </td>
                      <td className="text-gray-600 p-3">05 Sep, 2005</td>
                      <td className="text-gray-600 p-3"> Final</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Unclaimed Shares and Dividends Of Transpek Industry Limited are in IEPF
                </h2>
              </div>
            ...
            <section id="why-my-Share" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Why my shares of Transpek Industry Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
