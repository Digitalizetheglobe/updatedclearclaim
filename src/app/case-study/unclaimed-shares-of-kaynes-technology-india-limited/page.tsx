...
import Kaynes from "../../../../public/casestudy/kaynes.jpg";
...
export default function UnclaimedsharesofKaynesTechnologyIndiaLimited() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">Kaynes Technology India Limited.              </span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            Kaynes Technology India Limited is a leading end-to-end electronics manufacturing solutions provider, specializing in high-mix, low- and medium-volume production. Established in 1988 and headquartered in Mysuru, Karnataka, the company caters to diverse sectors including industrial automation, automotive, aerospace, defense, railways, medical, IT, and IoT-enabled smart devices. With a strong emphasis on innovation and quality, Kaynes offers services across the entire product lifecycle, from design and prototyping to manufacturing and after-sales support.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Kaynes operates state-of-the-art manufacturing facilities across India, adhering to stringent global quality standards. Its offerings include Printed Circuit Board Assembly (PCBA), box-build services, system integration, and cable harness assembly. The company also supports customers with embedded design solutions, enabling businesses to accelerate their time-to-market.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            A key differentiator for Kaynes is its focus on creating customized solutions tailored to client requirements. Its robust R&D capabilities and design expertise enable it to serve both domestic and international clients effectively, ensuring scalability and flexibility.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            In addition to electronics manufacturing, Kaynes is a strategic partner for India’s defense and aerospace sectors, supplying mission-critical components and systems. The company also focuses on sustainability by implementing energy-efficient manufacturing practices and aligning with global environmental standards.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Listed on the Indian stock exchanges, Kaynes Technology is well-positioned to benefit from the increasing demand for electronics and the rapid adoption of IoT and Industry 4.0. Its commitment to innovation, customer-centric solutions, and operational excellence makes it a trusted partner in the global electronics ecosystem.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b>   Kaynes Technology India Limited.
                </li>
                <li>
                  <b>CIN Number: </b> L29128KA2008PLC045825
                </li>
                <li>
                  <b>ISIN Number: </b> INE918Z01012
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Kaynes Technology India Ltd.                  {" "}
                </h2>
              </div>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <p className="text-gray-500">Kaynes Tech has acquired an Austria-based company Sensonic, in an effort to enhance its capabilities in railway safety and infrastructure management, the company said on 3rd December 2024.</p>
            </section>
            ...
            <section id="faq" className="mt-8 p-6 ">
              <div className="flex gap-4 items-center ">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                  FAQs about unclaimed shares of Jio Financial Services Ltd.
                </h2>
              </div>
            </section>
