...
import venky from "../../../../public/casestudy/Venky-s_India.webp";
...
export default function VenkysIndiaLtd() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">Venkys India Ltd.</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            Venkys (India) Limited, established in 1976 as Western Hatcheries Limited, is a leading poultry and animal healthcare company based in Pune, India. The company operates across three main segments: Poultry and Poultry Products, Animal Health Products, and Oilseed. It is a subsidiary of Venkateshwara Hatcheries Private Limited.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            In the Poultry segment, Venkys produces and sells broiler and layer chicks, processed chicken products, and poultry feed. It is also a global supplier of Specific Pathogen Free (SPF) eggs, a critical input for vaccine manufacturing. The companys Animal Health Products division focuses on bird medicines, nutritional supplements, and disease-preventing products. Additionally, its Oilseed segment offers edible refined soybean oil and de-oiled soybean cakes.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Venkys is also expanding its reach in the food industry through its quick-service restaurant brand, Venkys XPRS, and processed chicken products targeted at retail and institutional clients. The company is a recognized name for quality and innovation in Indias agricultural and food processing sectors.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Its contributions extend to international markets, making it a significant player in the global poultry industry. With a strong focus on research and innovation, Venkys continues to address the growing demand for safe and high-quality poultry products.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Venky’s India Ltd.
                </li>
                <li>
                  <b>CIN Number: </b> L01222PN1976PLC017422
                </li>
                <li>
                  <b>ISIN Number: </b> INE398A01010
                </li>
              </ul>
            </section>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">08 Sep 2023</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">08 Sep 2022</td>
                      <td className="text-gray-600 p-3">13.00</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">09 Sep 2022</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      22 Jul 2021
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">27 Aug 2015</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">28 Jul 2011</td>
                      <td className="text-gray-600 p-3">5.00</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">13 Jul 2007</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">22 Jul 2003</td>
                      <td className="text-gray-600 p-3">3.00</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
            ...
            <section id="faq" className="mt-8 p-6 ">
              <div className="flex gap-4 items-center ">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                FAQs about unclaimed shares of Venkys India Ltd.
                </h2>
              </div>
            </section>
