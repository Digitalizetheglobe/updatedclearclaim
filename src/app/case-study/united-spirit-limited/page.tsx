...
import united from "../../../../public/casestudy/United-Spirits-Limited-Banner-Image.jpg";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";


export default function UNITEDSPIRITSLIMITED() {
      ...
      <div>
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            UNITED
              <span className="text-green-600"> SPIRITS LIMITED</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            United Spirits Limited, commonly referred to as USL, is an Indian company specializing in alcoholic beverages and ranks as the second-largest spirits company globally by volume. 
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            It operates as a subsidiary of Diageo and is based at UB Tower in Bangalore, Karnataka. USL distributes its products to more than 37 countries.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            As stated on the companys official website, as of March 2013, USL boasts a portfolio of over 140 liquor brands.
            </p>
            <Image
              src={united}
              alt="united"
...
<p className="mb-6 text-[#00000099] text-justify">
            ...
            <p className="mb-6 text-[#00000099] text-justify">
            United Spirits Ltd (United Spirits), a subsidiary of Diageo plc, manufactures and sells alcoholic beverages. The companys product portfolio comprises Indian-made foreign liquor (IMFL) whisky, brandy, rum, vodka, gin and wine.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            United Spirits Ltd.(USL) is the countrys leading beverage alcohol company and a subsidiary of global leader Diageo PLC.
            </p>
            ...
            <section className="bg-white p-4">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> United Spirits Limited 
                </li>
                <li>
                  <b>CIN Number: </b>L01551KA1999PLC024991 
                </li>
                <li>
                  <b>ISIN Number: </b>INE854D01024
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                Dividend History Of United Spirits Limited 
                </h2>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">16 May, 2013</td>
                      <td className="text-gray-600 p-3">16 Sep, 2013 </td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">03 Aug, 2011</td>
                      <td className="text-gray-600 p-3">21 Sep, 2011 </td>
                      <td className="text-gray-600 p-3">Final </td>
                      <td className="text-gray-600 p-3">2.50</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">22 Sep, 2009</td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">01 Nov, 2007</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">09 Nov, 2006 </td>
                      <td className="text-gray-600 p-3">08 Dec, 2006</td>
                      <td className="text-gray-600 p-3">Final </td>
                      <td className="text-gray-600 p-3">2.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">28 Jun, 2004 </td>
                      <td className="text-gray-600 p-3">21 Sep, 2004 </td>
                      <td className="text-gray-600 p-3">Final </td>
                      <td className="text-gray-600 p-3">2.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">19 Aug, 2010</td>
                      <td className="text-gray-600 p-3">21 Sep, 2010</td>
                      <td className="text-gray-600 p-3">Final </td>
                      <td className="text-gray-600 p-3">2.50</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">19 Dec, 2008 </td>
                      <td className="text-gray-600 p-3">Final </td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">12 Mar, 2007</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">30 Jul, 2002</td>
            ...
            <section id="split" className="mt-6 bg-white p-4 ">
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-gray-600 p-3">13 Apr, 2018</td>
                      <td className="text-gray-600 p-3">15 Jun, 2018</td>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <p className="text-gray-500">United Spirits Limited (NSEI:MCDOWELL-N) completed the acquisition of remaining 25% stake in Pioneer Distilleries Limited. United Spirits Limited (NSEI:MCDOWELL-N) agreed to acquire remaining 25% stake in Pioneer Distilleries Limited (BSE:531879) for INR 4.3 billion on December 2, 2019.</p>
            </section>
            ...
            <section id="why-my-Share" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Why my shares of United Spirits Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
