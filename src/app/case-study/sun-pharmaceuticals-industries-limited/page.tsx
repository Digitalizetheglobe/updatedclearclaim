...
import sun from "../../../../public/casestudy/SUN.png";
      ...
      <div>
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            Sun Pharmaceutical Industries Limited is a leading global pharmaceutical company headquartered in Mumbai, India. Founded in 1983 by Dilip Shanghvi, the company initially focused on producing psychiatric medicines but has since expanded into a diverse range of therapeutic areas, including cardiology, dermatology, neurology, and oncology. Sun Pharma is renowned for its high-quality generic medications, over-the-counter (OTC) products, and active pharmaceutical ingredients (APIs).
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            With a presence in over 100 countries, Sun Pharma has become one of the largest and most successful pharmaceutical companies in India and globally. It is recognized for its extensive portfolio of branded generics and specialty drugs, with strong market positions in the United States, India, and emerging markets. The company’s acquisition strategy has been instrumental in its growth, notably its purchase of Ranbaxy Laboratories in 2015, which significantly expanded its product offerings and global footprint.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Sun Pharma’s commitment to research and development is evident in its robust pipeline of new products, focusing on high-value treatments, complex generics, and biologics. The company operates numerous manufacturing facilities across the world, adhering to stringent regulatory standards, including those set by the U.S. Food and Drug Administration (FDA).
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            In addition to its core pharmaceutical business, Sun Pharma has also made strides in improving patient access to healthcare through partnerships, collaborations, and CSR initiatives. The companys dedication to innovation, quality, and patient care continues to drive its position as a leader in the global pharmaceutical industry.
            </p>
            <Image
              src={sun}
              alt="sun logo"
            ...
            <section className="bg-white p-4">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Sun Pharmaceuticals Industries Limited.
                </li>
                <li>
                  <b>CIN Number: </b> L24230GJ1993PLC019050
                </li>
                <li>
                  <b>ISIN Number: </b> INE044A01036
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend History Of Sun Pharmaceuticals Industries Limited
                </h2>
              </div>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">28 Jul 2023</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">08 Feb 2023</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">10 Feb 2022</td>
                    </tr>


                    <tr>
                      <td className="text-gray-600 p-3">19 Aug 2022</td>
                      <td className="text-gray-600 p-3">3.00</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">22 Aug 2022</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      23 Aug 2021
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">INTERIM</td>
                      <td className="text-gray-600 p-3">10 Feb 2021</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      19 Aug 2020
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">18 Sep 2017</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">21 Oct 2015</td>
                      <td className="text-gray-600 p-3">3.00</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">19 Sep 2013</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">INTERIM</td>
                      <td className="text-gray-600 bg-gray-100 p-3">16 Aug 2012</td>
                    </tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">21 Aug 2009</td>
                      <td className="text-gray-600 p-3">13.75</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">INTERIM</td>
                      <td className="text-gray-600 p-3">16 Mar 2007</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      06 Sep 2006
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">19 Sep 2005</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">24 Sep 2003</td>
                      <td className="text-gray-600 p-3">5.00</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">20 Aug 2002</td>
                      <td className="text-gray-600 p-3">5.00</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">29 May 2004</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">2:1</td>
                      <td className="text-gray-600 p-3">23 Mar 2000</td>
                    </tr>
                    </tbody>
                    </table> 
            </section>
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">26 Nov 2010</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">10</td>
                      <td className="text-gray-600 p-3">5</td>
                      <td className="text-gray-600 p-3">21 Jan 2003</td>
                    </tr>
                    </tbody>
                    </table> 
            </section>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <p className="text-gray-500">In January 2024, Sun Pharma entered into a definitive merger with Taro Pharmaceuticals to acquire the remaining stake in Taro Pharma for $347.73 Million. Taro Pharma , the U.S.-based unit of Indias leading drugmaker Sun Pharma Ltd, has unveiled a merger agreement with its parent company. Under this agreement, Sun Pharma, the controlling shareholder of Taro, will acquire all outstanding shares of its subsidiary.</p>
            </section>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Unclaimed Shares and Dividends Of Sun Pharmaceuticals Industries Limited are in IEPF 
                </h2>
              </div>
            ...
            <section id="why-my-Share" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                Why my shares of Sun Pharmaceuticals Industries Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
          ...
          <aside className="w-1/5 bg-white shadow-md p-4 hidden md:block overflow-y-auto"  style={{
            ...
            <ul className="space-y-2">
              ...
              >
                <a href="#why-my-Share">
                  Why my Shares of Sun Pharmaceuticals Industries Ltd are in IEPF?
                </a>
              </li>
              <li
                className={`hover:bg-gray-200 p-2 rounded-md text-[15px]${
