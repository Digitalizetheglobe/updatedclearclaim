      ...
      <div>
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <p className="mb-6 text-[#00000099] text-justify">
              Grasim is India's leading exporter of Viscose Rayon Fiber, serving
