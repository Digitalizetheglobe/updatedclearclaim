...
import asahi from "../../../../public/casestudy/asahi-india-glass.png";
...
export default function UnclaimedsharesAsahuIndiaGlass() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">Asahi India Glass Ltd.</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
              Asahi India Glass Ltd. (AIGL) is one of the leading manufacturers
              of automotive and architectural glass in India. Established in
              1984, it is a joint venture between Asahi Glass Co. of Japan and
              Indian shareholders. Over the years, AIGL has grown to become a
              prominent player in the Indian glass industry, known for its
              high-quality products and innovative solutions.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              The company primarily focuses on producing float glass, automotive
              glass, and value-added products such as mirrors and processed
              glass. AIGL serves a wide range of sectors including automotive,
              construction, furniture, and solar energy. Its product offerings
              ...
              advanced materials in the building and automotive sectors.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              AIGL has a strong manufacturing and distribution network with
              state-of-the-art production facilities in locations such as
              Haryana, Rajasthan, and Tamil Nadu. Its automotive glass division
              supplies glass to a variety of automobile manufacturers, while its
              architectural division serves both domestic and international
              markets, providing products like tempered glass, laminated glass,
              and insulated glass units.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              With a focus on quality, innovation, and sustainability, Asahi
              India Glass Ltd. has established itself as a leader in the Indian
              glass industry. The company also prioritizes corporate social
              responsibility (CSR), contributing to various environmental and
              community welfare initiatives. It continues to adapt to industry
              trends, leveraging modern technologies and eco-friendly practices
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Asahi India Glass Ltd.
                </li>
                <li>
                  <b>CIN Number: </b>L26102DL1984PLC019542
                </li>
                <li>
                  <b>ISIN Number: </b> INE439A01020
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Asahi India Glass Ltd.
                </h2>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">07 Sep 2022</td>
                      <td className="text-gray-600 p-3">2.00</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">21 Mar 2020</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                        29 Jul 2019
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">04 Aug 2016</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">0.65</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">21 Jul 2006</td>
                      <td className="text-gray-600 p-3">0.60</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">22 Jul 2004</td>
            ...
            <section id="bonus" className="bg-white p-4 mt-6">
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                ...
                <tbody>
                  <tr>
                    <td className="text-gray-600 p-3">01 Sep 2005</td>
                    <td className="text-gray-600 p-3">1:1</td>
                    <td className="text-gray-600 p-3">02 Sep 2005</td>
                  </tr>
                  <tr>
                    <td className="text-gray-600 p-3 bg-gray-100">
                      14 Aug 2001
            ...
            <section id="split" className="mt-6 bg-white p-4 ">
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                ...
                <tbody>
                  <tr>
                    <td className="text-gray-600 p-3">08 Oct 2002</td>
                    <td className="text-gray-600 p-3">10</td>
                    <td className="text-gray-600 p-3">1</td>
                    <td className="text-gray-600 p-3">18 Oct 2002 </td>
                  </tr>
                </tbody>
              </table>
            </section>
            ...
            <section id="physical-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Physical Shares of Asahi India Glass Ltd.                </h2>
              </div>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed Shares and Dividends of Asahi India Glass Ltd.
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
...
For instance, unclaimed dividends and shares for financial years 2014-15 and beyond are being transferred, with a specific cutoff date. If the dividends have not been claimed by shareholders, their respective shares will be transferred to IEPF, and the original share certificates become void and non-negotiable. Affected shareholders are notified, and are given the chance to claim unclaimed dividends before the transfer happens.
            ...
            <section id="faq" className="mt-8 p-6 ">
              <div className="flex gap-4 items-center ">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                FAQs about unclaimed shares of Asahi India Glass Ltd.                </h2>
              </div>
            </section>
