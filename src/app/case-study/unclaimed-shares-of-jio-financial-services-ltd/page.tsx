...
import JIO from "../../../../public/casestudy/jio.jpg";
...
export default function UnclaimedSharesofJioFinancialServicesLtd() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">Jio Financial Services Ltd.              </span>
            </h1>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b>  Jio Financial Services Ltd.
                </li>
                <li>
                  <b>CIN Number: </b> L65990MH1999PLC120918
                </li>
                <li>
                  <b>ISIN Number: </b> INE758E01017
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Jio Financial Services Ltd.                  {" "}
                </h2>
              </div>
            ...
            <section id="physical-shares" className="mt-8 bg-white p-6 ">
              ...
              In the demerger, shareholders of RIL received one equity share of JFSL for every share they held in RIL. RIL also transferred Rs 15,500 crore of cash and liquid investments to JFSL.
            ...
            <section id="physical-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Physical Shares of Jio Financial Services Ltd.
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed shares and Dividend of Jio Financial Services Ltd. Transferred to IEPF

                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
              Since JFSL was recently demerged from Reliance Industries Ltd. and listed on the stock exchanges in 2023, the timeline for transferring any unclaimed dividends or shares to the IEPF has not yet been met. However, it is important for shareholders to ensure their details, such as demat account information, are up-to-date to avoid complications in receiving dividends or credit for shares. 
              </p>
            </section>
