...
import infra from "../../../../public/casestudy/infra.png";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";
import { useEffect, useState, useRef } from "react";


export default function JSWInfrastructureLimited() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              {" "}
              JSW 
              <span className="text-green-600"> Infrastructure Limited</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            JSW Infrastructure India Limited is a prominent player in the Indian infrastructure sector, part of the JSW Group, a leading conglomerate in the country. The company specializes in providing a wide range of services related to port and terminal operations, logistics, and integrated infrastructure solutions. With a strong presence across India, JSW Infrastructure operates multiple ports, including those along the Western and Eastern coasts, such as the JSW Jaigarh Port in Maharashtra and the JSW Paradip Port in Odisha.

            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            The company is involved in port operations, cargo handling, logistics, and the development of industrial infrastructure to support the growing demand for trade and commerce. JSW Infrastructure is recognized for its advanced infrastructure development, efficient operations, and a focus on sustainable practices. It aims to provide world-class services to its customers, ensuring seamless connectivity for cargo transportation and facilitating international trade.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            JSW Infrastructure’s key strengths include its strategic locations, robust infrastructure, and technological integration that enhances operational efficiency. The company’s commitment to expanding its network and investing in modern facilities positions it as a critical player in India’s growing infrastructure sector.

            </p>
            <p className="mb-6 text-[#00000099] text-justify ">
            JSW Infrastructure also focuses on reducing environmental impact by adopting green initiatives, aiming to create a balance between growth and sustainability. With its diverse portfolio and strong operational capabilities, the company is well-positioned to meet the increasing demand for logistics and infrastructure services in India, contributing to the country’s economic growth and development.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                ...
                <li>
                  <b>CIN Number: </b> U45200MH2006PLC161268
                </li>
                <li>
                  <b>ISIN Number: </b> INE880J01026
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of JSW Infrastructure Limited
                </h2>
              </div>
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                <thead className="bg-[#00BE5D] text-white">
                  <tr>
                  <th className="text-left p-3">Ex-Dividens Date</th>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed Shares and Dividends Of JSW Infrastructure Limited are in IEPF 
                </h2>
              </div>
            ...
            <section id="whymyshares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Why my shares of JSW Infrastructure Limited are in IEPF?
            ...
            <section id="company-details" className="p-4 mt-8">
              ...
              <div className="gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <Link
                    href="https://www.jsw.in/infrastructure  
"
                    className="text-md text-[#00000099] "
                  >
            ...
            <ul className="space-y-2">
              ...
              >
                <a href="#unclaimed-sharess">
                  Unclaimed Shares and Dividends Of JSW Infrastructure Limited
                </a>
              </li>
              <li
                className={`hover:bg-gray-200 p-2 rounded-md text-[15px] ${
