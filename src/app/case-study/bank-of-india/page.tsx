...
import bankindia from "../../../../public/casestudy/bank-of-india.jpg";
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              <span className="text-green-600"> Bank Of India</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
              Bank Of India established in 1906 in Mumbai, is one of Indias
              largest public sector banks. It was nationalized in 1969 and has
              since played a key role in the Indian banking landscape. BOI
              offers a wide range of financial products and services, including
              retail banking, corporate banking, loans, and investment options,
              catering to individuals, businesses, and government
              organizations.With a network of over 5,000 branches in India and a
              presence in more than 20 countries, BOI serves a diverse customer
              base both domestically and internationally. The bank provides
              services such as savings and current accounts, personal and
              business loans, digital banking, and wealth management. It is also
              a major player in trade finance, offering solutions for
              export/import transactions and working capital finance.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              BOI has been proactive in adopting digital banking, enabling
              customers to access services through internet banking, mobile
              apps, and ATMs. The bank has also focused on financial inclusion,
              providing banking services to underserved rural areas and
              promoting government schemes like Pradhan Mantri Jan Dhan Yojana.{" "}
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              As a government-owned entity, Bank of India plays a significant
              role in the nations economic growth, supporting both large
              corporations and small entrepreneurs. Despite challenges related
              to non-performing assets (NPAs), the bank remains a vital part of
              Indias financial system and continues to focus on profitability,
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Bank Of India
                </li>
                <li>
                  <b>CIN Number: </b> U99999MH1906PLC000243
                </li>
                <li>
                  <b>ISIN Number: </b> INE084A01016
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Bank Of India
                </h2>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">13 Jan, 2014</td>
                      <td className="text-gray-600 p-3">23 Jan, 2014</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">21 Jun, 2012</td>
                      <td className="text-gray-600 p-3">Interim</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">07 May, 2010</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">26 Feb, 2009</td>
                      <td className="text-gray-600 p-3">13 Mar, 2009</td>
                      <td className="text-gray-600 p-3">Interim</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">23 Apr, 2007</td>
                      <td className="text-gray-600 p-3">29 Jun, 2007</td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">07 Feb, 2005</td>
                      <td className="text-gray-600 p-3">21 Feb, 2005</td>
                      <td className="text-gray-600 p-3">Interim</td>
                      <td className="text-gray-600 p-3">1.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">13 Feb, 2004</td>
                      <td className="text-gray-600 p-3">Interim</td>
                      <td className="text-gray-600 p-3">2.00</td>
                    </tr>
                    <tr>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                  Unclaimed Shares and Dividends Of Bank Of India Transferred To
                  IEPF{" "}
                </h2>
              </div>
            ...
            <section id="whymyshares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                  Why my shares of Bank Of India are in IEPF?{" "}
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
            ...
            <section id="company-details" className="p-4 mt-8">
              ...
              <div className="gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <p className="text-md text-[#00000099]">Bank Of India</p>
                </div>
                <div className="flex items-center gap-2">
                  <p className="text-md text-[#00000099] ">
                    http://bankofindia.co.in/
                  </p>
                </div>
              </div>
            </section>
            ...
            <ul className="space-y-2">
              ...
              >
                <a href="#unclaimed-sharess">
                  Unclaimed Shares and Dividends Of Bank Of India
                </a>
              </li>
              <li
                className={`hover:bg-gray-200 p-2 rounded-md text-[15px]${
