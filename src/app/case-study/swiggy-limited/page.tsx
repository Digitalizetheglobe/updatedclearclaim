...
import swiggy  from "../../../../public/casestudy/swiggy.jpeg";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";
import { useEffect, useState, useRef } from "react";


export default function SWIGGYLIMITED() {
      ...
      <div> 
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            Swiggy is a prominent online food ordering and delivery service that has made a significant impact on the Indian food and beverage industry since its inception in 2014. Headquartered in the bustling city of Bangalore, Swiggy has rapidly expanded its operations and, as of July 2023, boasts a presence in over 580 cities across India, making it one of the largest food delivery platforms in the country.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Swiggys user-friendly mobile app and website allow customers to browse a wide variety of local restaurants, view menus, and place orders with just a few clicks. 
            </p>
            <Image
              src={swiggy}
              alt="swiggy  Logo"
...
<p className="mb-6 text-[#00000099] text-justify">
Overall, Swiggys commitment to leveraging technology and understanding consumer needs has solidified its position as a leader in the online food delivery and logistics space in India. With its ongoing expansion and diversification into new service areas, Swiggy is well-poised to continue shaping the future of food delivery and e-commerce in the country.
            </p>
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Swiggy limited.
                </li>
                <li>
                  <b>CIN Number: </b> U74110KA2013PLC096530 
                </li>
                <li>
                  <b>ISIN Number: </b> INE00H001014 
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Swiggy limited.
                </h2>
              </div>
              <div className="overflow-x-auto">
              <p className="text-gray-500">Swiggy Ltd. has not given any dividends since Jan 1, 2000.</p>
              </div>
            </section>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              Maruti Suzuki India Limited (MSIL) is merging with Suzuki Motor Gujarat Private Limited (SMG) to consolidate operations and improve efficiency. The merger is expected to be completed in September 2025
              </p>
            </section>
            ...
            <section id="physical-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed Shares and Dividends Of  Swiggy Limited Transferred To IEPF
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
...
are used for various purposes as outlined in the Act. The IEPFA Authority is responsible for managing the IEPF, handling refunds for shares, unclaimed dividends, matured deposits, and debentures, while also working to educate investors and protect their interests.
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Why my shares of Swiggy Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
