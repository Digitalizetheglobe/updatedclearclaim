...
import Ncl from "../../../../public/casestudy/ncl.jpeg";
...
export default function NCLIndustriesLimited() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">NCL Industries Limited</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            NCL Industries Limited is a prominent player in India’s building materials and construction industry, established in 1979 and headquartered in Hyderabad, Telangana. The company operates in diverse segments, including cement, ready-mix concrete, cement bonded particle boards, and energy-efficient doors and windows. Its flagship brand, Nagarjuna Cement, is well-recognized in southern India for its superior quality and durability, catering to infrastructure, residential, and industrial construction needs.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            NCL Industries is one of the pioneers in introducing Cement Bonded Particle Boards (Bison Panels) in India, which are widely used in construction and interior applications for their versatility and eco-friendliness. The company’s manufacturing facilities are strategically located in Telangana and Andhra Pradesh, ensuring efficient distribution across its primary markets.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            The company also operates in the renewable energy sector, generating power to support its manufacturing operations. NCL has embraced sustainability through initiatives aimed at reducing its environmental footprint, including the adoption of eco-friendly production techniques and energy-efficient processes.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            NCL Industries places a strong emphasis on innovation, quality, and customer satisfaction. Its ready-mix concrete division and pre-hung doors and windows business cater to evolving market demands, ensuring faster and more efficient construction solutions.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Listed on the Bombay Stock Exchange (BSE) and National Stock Exchange (NSE), NCL Industries continues to strengthen its market presence through consistent product quality, innovation, and a focus on sustainable growth, making it a trusted name in India’s building materials sector.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b>  NCL Industries Ltd.
                </li>
                <li>
                  <b>CIN Number: </b> L33130TG1979PLC002521
                </li>
                <li>
                  <b>ISIN Number: </b> INE732C01016
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of NCL Industries NCL Industries Ltd.</h2>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-gray-600 p-3">13 Sep 2024</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">21 Feb 2024</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">INTERIM</td>
                      <td className="text-gray-600 bg-gray-100 p-3">23 Feb 2023</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">19 Sep 2022</td>
                      <td className="text-gray-600 p-3">1.50</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">-</td>
                    </tr>
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">INTERIM</td>
                      <td className="text-gray-600 bg-gray-100 p-3">23 Feb 2022</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">17 Sep 2021</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">INTERIM</td>
                      <td className="text-gray-600 bg-gray-100 p-3">14 May 2021</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">19 Nov 2020</td>
                      <td className="text-gray-600 p-3">1.50</td>
                      <td className="text-gray-600 p-3">INTERIM</td>
                      <td className="text-gray-600 p-3">20 Nov 2020</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 ">INTERIM</td>
                      <td className="text-gray-600 p-3 ">20 Mar 2020</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">22 Feb 2018</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">
                      14 Sep 2017
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">INTERIM</td>
                      <td className="text-gray-600 p-3 bg-gray-100">23 Feb 2017</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">
                      09 Sep 2016
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">INTERIM</td>
                      <td className="text-gray-600 p-3 bg-gray-100">10 Feb 2016</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">
                      05 Sep 2012
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">INTERIM</td>
                      <td className="text-gray-600 p-3 bg-gray-100">20 Apr 2006</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">
                      05 Dec 2005
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <div className="text-[#00000099] leading-6 mb-6 text-justify">
                <li>
                NCL Industries has concluded a share purchase agreement with the owners of Vishwamber Cements. Under the deal, NCL Industries will acquire 100% ownership of Vishwamber Cements. The group says that it plans to merge the newly acquired subsidiary into its own cement business.
            ...
            <section id="faq" className="mt-8 p-6 ">
              <div className="flex gap-4 items-center ">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                FAQs about unclaimed shares of NCL Industries Ltd.
                </h2>
              </div>
            </section>
