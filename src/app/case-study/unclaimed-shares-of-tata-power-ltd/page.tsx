...
import power from "../../../../public/casestudy/tatapower.webp";
...
export default function UnclaimedSharesofTATAPowerLtd() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">TATA Power Ltd.</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            Tata Power Ltd., established in 1915, is a leading player in the Indian energy sector with a diverse portfolio spanning power generation, transmission, and distribution. As part of the Tata Group, the company operates across various energy sources, including thermal, hydro, solar, and wind. It has a total renewable energy capacity of 10 GW, with significant investments in solar manufacturing and battery energy storage solutions. Tata Power has pioneered solar rooftop installations in India and developed innovative projects such as floating solar farms
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Tata Power is also a key contributor to Indias electric vehicle (EV) ecosystem, operating over 5,500 public and private EV charging stations nationwide. The company emphasizes sustainability through biodiversity initiatives, renewable energy expansion, and energy conservation programs like Club Enerji. Additionally, it actively participates in CSR projects, such as skill development and environmental conservation
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            With a strong focus on innovation and green energy, Tata Power continues to lead India’s transition toward cleaner and more efficient energy solutions. The company’s future plans include further renewable energy expansion, smart metering technologies, and advancing EV infrastructure.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> TATA Power Ltd.
                </li>
                <li>
                  <b>CIN Number: </b> L28920MH1919PLC000567
                </li>
                <li>
                  <b>ISIN Number: </b> INE245A01021
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
Dividend’s History of TATA Power Ltd.
                </h2>
              </div>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">04 Jul, 2024</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">1.55</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">19 May, 2020</td>
                      <td className="text-gray-600 p-3">14 Jul, 2020</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">1.55</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 bg-gray-100 p-3">
                      02 May, 2019
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">02 May, 2018</td>
                      <td className="text-gray-600 p-3">12 Jul, 2018</td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">24 May, 2016</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">1.30</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3 bg-gray-100">FINAL</td>
                      <td className="text-gray-600 p-3 bg-gray-100">1.15</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">22 May, 2012</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">25 May, 2010</td>
                      <td className="text-gray-600 p-3">16 Aug, 2010</td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">29 May, 2006</td>
                      <td className="text-gray-600 p-3">07 Jul, 2006</td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">21 May, 2004</td>
            ...
            <section id="bonus" className="bg-white p-4 mt-6">
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                ...
                <tbody>
                  <tr>
                    <td className="text-gray-600 p-3">19 May, 1975</td>
                    <td className="text-gray-600 p-3">-</td>
                    <td className="text-gray-600 p-3">1:5</td>
                  </tr>
                </tbody>
              </table>
              <p>Remark : For every 5 share held; Holder will receive 1 bonus shares.</p>
            </section>
            ...
            <section id="split" className="mt-6 bg-white p-4 ">
              ...
              <table className="min-w-full border-collapse border border-gray-200 mt-4">
                ...
                <tbody>
                  <tr>
                    <td className="text-gray-600 p-3">19 May, 2011</td>
                    <td className="text-gray-600 p-3">26 Sep, 2011</td>
                    <td className="text-gray-600 p-3">10</td>
                    <td className="text-gray-600 p-3">1</td>
                  </tr>

                  <tr>
                    <td className="text-gray-600 p-3">22 May, 1995</td>
                    <td className="text-gray-600 p-3">22 May, 1995</td>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <p className="text-gray-500">Tata Power, a leading Indian electric utility, has undergone significant corporate restructuring through mergers and amalgamations in recent years. In March 2022, the company received approval from the National Company Law Tribunal (NCLT) for the amalgamation of Af-Taab Investment Company with Tata Power. This merger was aimed at streamlining operations and maximizing shareholder value. The scheme of amalgamation was carried out under Sections 230 to 232 of the Companies Act, 2013</p>
              <p className="text-gray-500">Additionally, Tata Power has been expanding its presence in the renewable energy sector through strategic acquisitions and mergers. For instance, in 2022, Tata Power Renewable Energy Limited (TPREL), a subsidiary, consolidated its renewable energy assets, including those of the Welspun group. This further reinforced Tata Power’s position in clean energy and its goal of achieving significant growth in renewable power capacity.</p>
              <p className="text-gray-500">These strategic steps reflect Tata Power’s commitment to strengthening its market leadership and aligning with the growing demand for renewable energy solutions, while maintaining operational efficiency.              </p>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed Shares and Dividends of TATA Power Ltd.
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
            ...
            <section id="faq" className="mt-8 p-6 ">
              <div className="flex gap-4 items-center ">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                FAQs about unclaimed shares of Supreme Petrochem Ltd.
                </h2>
              </div>
            </section>
