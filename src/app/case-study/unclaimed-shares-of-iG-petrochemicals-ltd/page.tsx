...
import IGPL from "../../../../public/casestudy/ipgl.png";
...
export default function UnclaimedSharesofIGPetrochemicalsLtd() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <h1 className="text-3xl font-semibold mb-4">
              Unclaimed Shares of{" "}
              <span className="text-green-600">IG Petrochemicals Ltd.</span>
            </h1>
            <p className="mb-6 text-[#00000099] text-justify">
            IG Petrochemicals Ltd. (IGPL) is a leading manufacturer of Phthalic Anhydride (PAN) in India, with a significant presence in the petrochemical industry. Established in 1988, the company is headquartered in Mumbai and operates a state-of-the-art production facility in Taloja, Maharashtra. IGPL has earned a reputation as one of the largest producers of PAN in South Asia, with a production capacity of over 2,20,000 metric tons annually.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Phthalic Anhydride is a critical raw material used in the production of plasticizers, alkyd resins, and polyester resins, which are key components in industries such as paints, plastics, and construction. IGPL also produces by-products like Maleic Anhydride and Benzoic Acid, enhancing its value chain.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            Known for its strong focus on sustainability, IGPL integrates environmentally friendly practices into its operations. It leverages advanced technologies to maintain high efficiency and reduce emissions. The company has consistently delivered robust financial performance, driven by strategic initiatives, operational excellence, and a commitment to customer satisfaction.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
            IGPL is listed on major stock exchanges in India, reflecting its strong market presence and investor confidence. With a vision to expand globally, IGPL continues to focus on innovation and capacity enhancement.
            </p>
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b>  I G Petrochemicals Ltd.
                </li>
                <li>
                  <b>CIN Number: </b> L51496GA1988PLC000915
                </li>
                <li>
                  <b>ISIN Number: </b> INE204A01010
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of I G Petrochemicals Ltd.                  {" "}
                </h2>
              </div>
                ...
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">29 Aug, 2024</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">24 Jun, 2020</td>
                      <td className="text-gray-600 p-3">18 Aug, 2020</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">16 Aug, 2018</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 p-3">23 Aug, 2016</td>
                      <td className="text-gray-600 p-3">FINAL</td>
                      <td className="text-gray-600 p-3">2.00</td>
                    </tr>
                    <tr>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              <div className="text-[#00000099] leading-6 mb-6 text-justify">
                <li>
                IG Petrochemicals Ltd amalgamated with Mysore Petrochemicals Ltd. (MPL) in the year 2017.
                </li>

                <li>
                This merger was a strategic move to consolidate operations, streamline management, and enhance production capabilities. It enabled IGPL to further strengthen its leadership position in the Phthalic Anhydride market by unifying resources, technology, and expertise under one entity.
                </li>
