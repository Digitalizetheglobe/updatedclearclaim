...
export default function GraphiteIndiaLimited() {
          ...
          >
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Graphite India Limited
                </li>
                <li>
                  <b>CIN Number: </b> U23109WB1962PLC025560
                </li>
                <li>
                  <b>ISIN Number: </b> INE371A01025
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend’s History of Graphite India Limited.
                </h2>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">25 Jul, 2014</td>
                      <td className="text-gray-600 p-3">Final</td>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">14 Jul, 2010</td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">3.50</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className="text-gray-600 p-3">16 Jul, 2007</td>
                      <td className="text-gray-600 p-3">Final</td>
