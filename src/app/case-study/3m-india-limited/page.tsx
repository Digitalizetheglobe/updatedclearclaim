...
import mlogo from "../../../../public/casestudy/3mindia.png";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";
import pin from "../../../../public/images/marker-pin-01.png";


export default function IndiaLimited() {
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            <p className="mb-6 text-[#00000099] text-justify">
              3M India Limited is a subsidiary of 3M Company, a global leader in
              innovation, headquartered in St. Paul, Minnesota, USA. The company
              is known for its cutting-edge solutions across various sectors,
              including healthcare, consumer goods, industrial, and safety
              products. Established in 1988, 3M India operates in over 10
              locations across the country and offers a wide range of products
              that cater to the needs of businesses, consumers, and government
              institutions. The company’s portfolio includes well-known brands
              like Post-it, Scotch, Nexcare, and Filtrete, covering categories
              such as adhesives, abrasives, electronics, medical supplies, and
              automotive solutions. 3M India emphasizes innovation and
              sustainability, investing heavily in research and development to
              introduce new technologies that address the challenges faced by
              industries in India.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              3M India also focuses on creating local manufacturing capabilities
              to support its commitment to the Indian market, fostering economic
              growth, and promoting skilled job creation. Through
              collaborations, partnerships, and corporate social responsibility
              initiatives, the company plays a significant role in contributing
              to India’s development while maintaining its global standards.
            </p>
            <p className="mb-6 text-[#00000099] text-justify">
              With its innovative products and focus on customer-centric
              solutions, 3M India continues to build its reputation as a trusted
              brand and a leader in providing sustainable and high-quality
            ...
            <section className="bg-white p-4">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> 3M India Limited
                </li>
                <li>
                  <b>CIN Number: </b>L31300KA1987PLC013543
                </li>
                <li>
                  <b>ISIN Number: </b>INE470A01017
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              <div className="flex gap-4">
                ...
                <h2 className="text-2xl text-gray-700 font-[600px] mb-2">
                  Dividend History Of 3M India Limited
                </h2>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-gray-600 p-3">28 May, 2024</td>
                      <td className="text-gray-600 p-3">05 Jul, 2024 </td>
                      <td className="text-gray-600 p-3">Final</td>
                      <td className="text-gray-600 p-3">160.00</td>
                    </tr>
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">525.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">Special</td>
                      <td className="text-gray-600 bg-gray-100 p-3">850.00</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                  Unclaimed Shares and Dividends Of 3M India Limited Transferred
                  To IEPF
                </h2>
              </div>
            ...
            <section id="why-my-Share" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700">
                  Why my shares of 3M India Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
            ...
            <section id="company-details" className="p-4 mt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <p className="text-md text-[#00000099]">3M India Limited</p>
                </div>
              
              </div>
              <div className="flex items-center gap-2 mb-2">
                  <Link className="text-md text-[#00000099] "
                 href=  'https://www.3mindia.in/3M/en_IN/company-in/'>
                  https://www.3mindia.in/3M/en_IN/company-in/</Link>
                </div>
              {/* Address */}
              <div className="flex gap-2 mt-1 ">
                <Image src={pin} alt="file" className="w-4 h-4" />
                <p className="text-md text-[#00000099] text-justify">
