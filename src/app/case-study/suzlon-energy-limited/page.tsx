...
import Suzlon  from "../../../../public/casestudy/suzlon.png";
import fileimg from "../../../../public/images/server-01.png";
import tick from "../../../../public/images/tick.svg";
import { useEffect, useState, useRef } from "react";

export default function SuzlonEnergyLimited() {
      ...
      <div> 
        ...
        <div className="h-screen flex bg-gray-100">
          ...
          >
            ...
            Suzlon
              <span className="text-green-600">Energy Limited.
              </span>
            </h1>
            ...
            <p className="mb-6 text-[#00000099] text-justify">
            Suzlon also plays a key role in advancing the Indian renewable energy sector, contributing significantly to the countrys renewable energy targets. Despite facing financial challenges in recent years, the company continues to work towards strengthening its position in the global renewable energy market.
            </p>
            <Image
              src={Suzlon}
              alt="Suzlon  Logo"
            ...
            <section className="bg-white p-4 ">
              ...
              <ul className="space-y-4 mt-4 text-gray-500">
                <li>
                  <b>Registered Name: </b> Suzlon Energy Limited.
                </li>
                <li>
                  <b>CIN Number: </b> L40100GJ1995PLC025447
                </li>
                <li>
                  <b>ISIN Number: </b> INE040H01021
                </li>
              </ul>
            </section>
            ...
            <section id="dividend-history" className="mt-6 bg-white p-4 ">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-200 mt-4">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-gray-600 p-3">17 July 2008</td>
                    ...
                    <tr>
                      ...
                      <td className="text-gray-600 bg-gray-100 p-3">5</td>
                    </tr>
                    <tr>
                      <td className="text-gray-600 p-3">6 July 2006</td>
                      <td className="text-gray-600 p-3">Final</td>
            ...
            <section id="mergers-amalgamation" className="mt-8 bg-white p-6 ">
              ...
              As on 6 September 2024, Suzlon Energy Limited acquired Renom Energy with 51% of equity share capital.
              </p>
            </section>
            ...
            <section id="physical-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Unclaimed Shares and Dividends Of Suzlon Energy Limited Transferred To IEPF
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
            ...
            <section id="unclaimed-shares" className="mt-8 bg-white p-6 ">
              <div className="flex gap-4 items-center mb-4">
                <Image src={tick} alt="tick" className="w-6 h-6" />
                <h2 className="text-2xl text-gray-700 ">
                Why my shares of Suzlon Energy Limited are in IEPF?
                </h2>
              </div>
              <p className="text-[#00000099] leading-6 mb-6 text-justify">
