      ...
      <main>
        <div>
          ...
          <div className="mx-auto max-w-screen-lg space-y-6 rounded-b-lg bg-white px-8 pt-10 pb-20 font-serif text-lg tracking-wide text-gray-700 sm:shadow-lg">
            ...
            <h2 className="text-xl font-semibold">Understanding Unclaimed Dividends and Shares</h2>
            <h2 className="text-xl font-semibold">What Are Unclaimed Dividends?</h2>
           ...
           <p>
           Change in investors address
Outdated bank information 
Lost or misplaced dividend warrants

           </p>

           <h2 className="text-xl font-semibold">What Are Unclaimed Shares?</h2>
...
On the other hand, unclaimed shares are equity participation in a company that an investor has forgotten or lost track of. This may be due to:
            ...
            <p>
            Failure to dematerialize physical share certificates
Loss of share certificates
Forgotten investments from the past
            </p>

            <h2 className="text-xl font-semibold">The Recovery Process: Unclaimed Dividends vs. Unclaimed Shares</h2>
            <h2 className="text-xl font-semibold">Recovering Unclaimed Dividends</h2>
            ...
            <h2 className="text-xl font-semibold">Documentation: Prepare necessary documents, including:</h2>
                     <li> PAN card</li>
           <li>Cancelled cheque</li>
           <li>Updated address proof</li>

           <h2 className="text-xl font-semibold">Claim Submission:</h2>
<li>
For current dividends: Call the companys registrar and transfer agent (RTA)</li>
<li>
...
<h2 className="text-xl font-semibold">Recovering Unclaimed Shares</h2>
            ...
            <h2 className="text-xl font-semibold">Documentation: Assemble documentation needed:</h2>
            ...
            <h2 className="text-xl font-semibold">IEPF Claim:</h2>

            <h2 className="text-xl font-semibold">For shares transferred to IEPF:</h2>
...
<p>
Dividend recovery is usually easier and quicker
Share recovery can be more complicated, particularly where physical certificates are involved.
</p>

              <h2 className="text-xl font-semibold">Time Frame:</h2>
              <h2 className="text-xl font-semibold">Dividend claims can be settled in weeks</h2>
...
Share recovery often requires much more detailed documentation, particularly for physical shares
        ...
        <h2 className="text-xl font-semibold">Involvement of IEPF:</h2>

        <p>
        Recent dividends can usually be claimed directly from companies
Unclaimed shares are more likely to be transferred to IEPF, requiring a more involved recovery process

        </p>

        <h2 className="text-xl font-semibold">Challenges in Recovery</h2>
<li>
Unclaimed Dividends
</li>
<li>
...
<h2 className="text-xl font-semibold">Tips for Successful Recovery</h2>
...
<h2 className="text-xl font-semibold">How Clearclaim Can Help</h2>
...
<h2 className="text-xl font-semibold">We offer services including:</h2>
...
Assistance with dematerialization of physical shares
            ...
            <h2 className="text-xl font-semibold">Conclusion: Reclaiming Your Financial Legacy</h2>
            <p>
