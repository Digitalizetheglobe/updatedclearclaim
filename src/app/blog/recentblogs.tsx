                  ...
                  <div className="bg-white mb-12 items-center cursor-pointer h-[450px] rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,190,93,0.8)] relative top-0 hover:-top-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        The Importance of Document Verification in IEPF Claims:
                        A Guide to an Effective Recovery Process
                      </h3>
                    </div>
                  </div>
                </Link>
                ...
                <Link href="/navigatingrules">
                  <div className="bg-white mb-12 items-center cursor-pointer h-[450px] rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,190,93,0.8)] relative top-0 hover:-top-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        Unclaimed Dividends vs. Unclaimed Shares: How to
                ...
                <Link href="/navigatingrules">
                  <div className="bg-white mb-12 items-center cursor-pointer h-[450px] rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,190,93,0.8)] relative top-0 hover:-top-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        The Role of KYC Updates in Preventing Unclaimed
                        Financial Assets
                      </h3>
                    </div>
                  </div>
                ...
                <Link href="/navigatingrules">
                  <div className="bg-white mb-12 items-center cursor-pointer h-[450px] rounded overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,190,93,0.8)] relative top-0 hover:-top-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        The Rise of Digital Platforms for Tracing Inactive
                        Financial Assets: What You Need to Know
                      </h3>
                    </div>
                  </div>
                </Link>
                ...
                <Link href="/heg-limited">
                  <div className="bg-white mb-12 cursor-pointer rounded h-[450px] overflow-hidden shadow-[0_2px_10px_-3px_rgba(0,190,93,0.8)] relative top-0 hover:-top-2 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800">
                        HEG Limiteds Major Announcement: Key Insights You Need
                        to Know
                      </h3>
                    </div>
                  </div>
