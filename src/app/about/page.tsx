          ...
          <div className="grid md:grid-cols-2 items-center md:gap-4 gap-6 max-w-5xl max-md:max-w-md mx-auto">
            <div className="max-md:order-1 max-md:text-center mt-6 max-md:mt-0">
              <p className="mt-2 text-[18px] text-black text-justify">
                ...
                fulfil those desires. All individuals try to invest to meet
                their basic needs, save a portion of their income, and invest in
                various avenues. Whether its a modest vision or a grand
                ambition, people invest their hard-earned money with the hope of
                realizing their dreams in the future. In India, countless
                individuals have invested in stocks, mutual funds, ULIPs,
                insurance schemes, bonds, FDs, RDs, gold, and more. As our
                nation progresses, transitioning from paper- based transactions
                to digital platforms has become the norm. Yet, not everyone has
                made this shift, and numerous investors still hold their
                investments in paper format.
              </p>
              <p className="mt-2 text-[18px] text-black text-justify max-md:mt-0">
                The Government of India has made substantial efforts to
                streamline this transition. However, considering India vast
                population of 1.25 billion people, it will naturally take time
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="text-left max-md:px-4">
                ...
                <p className="mb-4 mt-4 text-md text-justify text-black">
                  ...
                  passion for the industry have been key factors in the
                  company’s success. His responsibilities include setting the
                  company’s overall strategic direction, making major corporate
                  decisions, and managing the overall operations and resources
                  of the company. Shrikant’s dedication and leadership continue
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-24">
              <div className="text-left max-md:px-4">
                ...
                <p className="mb-4 mt-4 text-md text-justify text-black">
                  ...
                  oversees the company’s day-to-day administrative and
                  operational functions. He heads the Operations team and
                  ensures the smooth claim processing. His commitment towards
                  excellency plays a very important role in customer success.
                  This helps in building the trust and transparency with client
                  which in turn build company reputation.{" "}
                </p>
              </div>
              <div className="max-h-72 max-md:order-1">
                <Image
